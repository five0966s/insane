...
NETVAR(m_iFOVStart,				 DT_BasePlayer)
NETVAR(m_iDefaultFOV,			 DT_BasePlayer)
...
public:
    ...
    NETVAR_SETTER(m_iFOV,       DT_BasePlayer, int32_t)
    NETVAR_GETTER(m_iFOV,       DT_BasePlayer, int32_t)
    NETVAR_SETTER(m_iFOVStart, DT_BasePlayer, int32_t)
    NETVAR_GETTER(m_iFOVStart, DT_BasePlayer, int32_t)
    NETVAR_SETTER(m_iDefaultFOV, DT_BasePlayer, int32_t)
    NETVAR_GETTER(m_iDefaultFOV, DT_BasePlayer, int32_t)
