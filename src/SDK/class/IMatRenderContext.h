...
public:
	...
	virtual void				OverrideDepthEnable_Bad(bool bEnable, bool bDepthEnable) = 0;
	...
	virtual void				OverrideDepthEnable(bool bEnable, bool bDepthEnable) = 0; //virtual void	SyncToken(const char* pToken) = 0;
	...
	virtual void				PushRenderTargetAndViewport_Bad() = 0;
	virtual void				PushRenderTargetAndViewport_Tx(void* pTexture) = 0;
	virtual void				PushRenderTargetAndViewportEx(void* pTexture, int nViewX, int nViewY, int nViewW, int nViewH) = 0;
	virtual void				PushRenderTargetAndViewport(void) = 0;
	...
	virtual void				SetStencilEnable(bool onoff) = 0; // index 117, starting from 0
