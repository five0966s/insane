...
void TickManipHelper_t::Run(BaseEntity* pLocalPlayer, baseWeapon* pActiveWeapon, CUserCmd* pCmd, bool* pSendPacket, bool* pCreateMoveResult)
{
    ...
    m_flOrigForwardMove = pCmd->forwardmove;
    m_flOrigSideMove    = pCmd->sidemove;
    ...
    // Stores bones at fake angles, eiter when fakelag is off or fake lag is on & bSendPacket = true.
    if(_ShouldRecordSecondModelBones(*pSendPacket) == true)
    {
        // In case antiaim is turned off, and we are storing bones to draw fakelag, 
        // we want the model to have real angles.
        qangle qEyeAngles = Features::AntiAim::AntiAim::AntiAim_Enable.IsActive() == true ?
            F::antiAimV2.GetFakeAngles() : qEngineAngles;

        _StoreBones(qEyeAngles, m_fakeAngleBones, pLocalPlayer);
    }
...
///////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////
bool TickManipHelper_t::ModifyRealBoneAngles() const
{
    return
...
///////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////
bool TickManipHelper_t::ShouldDrawSecondModelGlow() const
{
    bool bAntiAimDrawEnabled =
        Features::AntiAim::AntiAim::AntiAim_Enable.IsActive()       == true &&
        Features::AntiAim::AntiAim_Visuals::AntiAim_Glow.IsActive() == true;

    bool bFakeLagDrawEnabled =
        Features::Misc::FakeLag::FakeLag_Enable.IsActive() == true &&
        Features::Misc::FakeLag::FakeLag_Glow.IsActive()   == true;
...
bool TickManipHelper_t::_ShouldRecordSecondModelBones(const bool bSendPacket) const
{
    ...
    if (Features::Misc::FakeLag::FakeLag_Enable.IsActive() == true && bWantToDraw == true && bSendPacket == false)
        return false;
...
void TickManipHelper_t::_DetectAndHandleShots(BaseEntity* pLocalPlayer, baseWeapon* pActiveWeapon, CUserCmd* pCmd, bool* pSendPacket)
{
    ...
    pCmd->forwardmove = m_flOrigForwardMove;
    pCmd->sidemove    = m_flOrigSideMove;
}
