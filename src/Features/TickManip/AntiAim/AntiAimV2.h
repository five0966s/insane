...
DEFINE_SECTION(AntiAim_Visuals, "AntiAim", 2)
DEFINE_FEATURE(AntiAim_Glow,        "Glow",        bool, AntiAim_Visuals, AntiAim, 1, false)
DEFINE_FEATURE(AntiAim_GlowClr, "Glow Clr", ColorData_t, AntiAim_Visuals, AntiAim, 2, ColorData_t((unsigned char)255, 255, 255, 255))
