...
private:
    ...
    void _RocketJumpAssist(BaseEntity* pLocalPlayer, baseWeapon* pActiveWeapon, CUserCmd* pCmd, bool& bCreateMoveResult);
...
DEFINE_FEATURE(PeekAssist_Size,      "PeekAssist Size",            FloatSlider_t, Movement, Movement, 9, FloatSlider_t(30.0f, 10.0f, 100.0f))

DEFINE_SECTION(RocketJumpAssist, "Movement", 2)
DEFINE_FEATURE(RocketJumpAssist,           "RocketJumpAssist",            bool, RocketJumpAssist, Movement, 1, false, FeatureFlag_SupportKeyBind | FeatureFlag_HoldOnlyKeyBind)
DEFINE_FEATURE(RocketJumpAssist_OffsetMin, "Rocket Offset Min",  FloatSlider_t, RocketJumpAssist, Movement, 2, FloatSlider_t(10.0f, 0.0f, 40.0f), FeatureFlag_None, "Rocket will be shot alteast this much behind you.")
DEFINE_FEATURE(RocketJumpAssist_OffsetMax, "Rocket Offset Max",  FloatSlider_t, RocketJumpAssist, Movement, 3, FloatSlider_t(30.0f, 0.0f, 40.0f), FeatureFlag_None, "Rocket will be shot atmost this much behind you.")
DEFINE_FEATURE(RocketJumpAssist_RJHeight,  "Rocket Jump Height", FloatSlider_t, RocketJumpAssist, Movement, 4, FloatSlider_t(20.0f, 20.0f, 40.0f), FeatureFlag_None, "When your height from ground is <= this much. We RJ.")